...
- URL base (Producción): `https://swaplt-backend-production.up.railway.app/api`
...
## 11. Entorno de Producción y Despliegue (Vercel)

El frontend está desplegado globalmente utilizando la Edge Network de **Vercel**.

### Build Automático
Vercel detecta automáticamente los cambios en la rama `main` y ejecuta:
```bash
